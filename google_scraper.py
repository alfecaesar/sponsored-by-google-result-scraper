...
try:
    ...
    print("Sponsored list is found. Saving screenshot as google-search-result-sponsored.png")
except NoSuchElementException:
    print("Sponsored list is not found")

print("*** Start of sponsored product list ***")
...
for product in sponsored_products:
    if not('view-all-unit' in product.get_attribute("class")):
        try:
        ...
        try:
            product_rating_star = product.find_element(By.CLASS_NAME, "z3HNkc").get_attribute("aria-label").replace(',', '')
        except NoSuchElementException:
...
print("*** End of sponsored product list ***")
